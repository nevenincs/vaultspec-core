...
- [x] `P05.S24` - Run python -m statistic over the operator in-window corpus and verify it emits the real records.jsonl and report.md into gitignored statistic/out/; `statistic/out/records.jsonl, statistic/out/report.md`.
