...
- [x] `W01.P03.S16` - Add a contract test pinning the public names and signatures other packages import for resolution, credentials, unattended detection and the install envelope; `src/vaultspec_core/tests/test_public_resolution_api.py`.
