...
- [x] `W03.P07.S33` - add modified to the curator's allowed frontmatter keys with the lenient-parse repair note; `src/vaultspec_core/builtins/agents/vaultspec-docs-curator.md`.
...
- [x] `W03.P08.S35` - describe the orientation surface and the modified stamp in the framework manual; `docs/framework.md`.
