...
- [x] `W01.P04.S24` - Run the full unit gate and perform an ADR-conformance review confirming the schema v2 migration, DEV mode, and per-package renderers match the install-parity ADR before the wave is released; `src/vaultspec_core`.
