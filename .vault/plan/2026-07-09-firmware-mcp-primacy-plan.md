...
- [x] `P05.S22` - Perform the mandatory closeout code review of the full reworded firmware set, confirming per-surface primacy split, three-band honesty, byte-stable gateway catalog, and unchanged allowlists against the ADR constraints; `src/vaultspec_core/builtins`.
