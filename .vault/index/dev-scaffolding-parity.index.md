...
- `2026-07-28-dev-scaffolding-parity-adr` - `dev-scaffolding-parity` adr: `baseline-ratcheted quality gates` | (**status:** `accepted`)

### plan

- `2026-07-28-dev-scaffolding-parity-plan` - `dev-scaffolding-parity` plan
