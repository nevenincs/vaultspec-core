...
cross-module refactors, changes where a wrong abstraction is expensive to undo. A
decision the ADR does not settle is a blocker, not a silent choice. Document the
