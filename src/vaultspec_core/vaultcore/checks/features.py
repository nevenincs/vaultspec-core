...
def check_features(
    ...
    *,
    ...
    - execution records without a plan: WARNING
    - decision and evidence coverage belongs to the schema checker
        ...
        if has_exec and not has_plan:
            result.diagnostics.append(
                CheckDiagnostic(
                    ...
                    fix_description=(
                        f"Consider: vaultspec-core vault add plan -f {feat_name}"
                    ),
                )
            )
