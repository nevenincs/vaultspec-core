...
class TestHooksDeclaration:
    ...
    def test_absent_file_is_permissive(self, factory):
        assert read_hooks_declaration(factory.root).pre_commit is True

    def test_declaration_without_hooks_key_is_permissive(self, factory):
        write_workspace_declaration(
            factory.root, WorkspaceDeclaration(install_mode=InstallMode.TOOL)
        )
    ...
    def test_default_policy_writes_no_hooks_key(self, factory):
    ...
    def test_opt_out_round_trips(self, factory):
    ...
    def test_opt_out_survives_a_mode_write(self, factory):
    ...
    def test_hook_write_preserves_package_entries(self, factory):
        write_package_declaration(
            factory.root,
            "vaultspec-rag",
    ...
    def test_non_object_hooks_raises(self, factory):
        _write_raw(
            factory.root,
    ...
    def test_non_boolean_pre_commit_raises(self, factory):
