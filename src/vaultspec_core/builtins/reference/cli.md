...
| `--gate-errors` | -     | off     | Fold the warning exit (1) to 0 so only errors (exit 2) fail; for CI and other automation gates, where expected provider-mirror lag must not fail the run. |
