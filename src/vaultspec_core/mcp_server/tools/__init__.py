...
Each module registers a slice of the ten-tool surface onto a shared
...
(``plan_progress`` / ``plan_edit``), and :mod:`gateway` owns the stateless
long-tail gateway (``discover`` / ``invoke``). All handlers route every mutation
through the shared
