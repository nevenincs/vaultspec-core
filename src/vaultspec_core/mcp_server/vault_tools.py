...
def register_tools(mcp: FastMCP) -> None:
    ...
    async def create(
        ...
        # the CLI ``vaultspec-core vault add`` path and stays stable regardless of the
        ...
        if doc_type is DocType.INDEX:
            # Indexes are auto-generated by ``vaultspec-core vault feature index``;
            # the create tool does not author them by hand.
            return {
                "success": False,
                "message": (
