...
:class:`~dev.statistics.normalize.models.CallRecord`. The protocol is generic over
...
class TranscriptSource(Protocol[SessionT]):
    ...
    emit validated :class:`~dev.statistics.normalize.models.CallRecord` instances.
    """
    ...
    def iter_calls(self, session: SessionT) -> Iterator[CallRecord]:
        ...
        Returns:
            ...
            :class:`~dev.statistics.normalize.models.CallRecord` instances, in
            transcript order.
        """
        ...
