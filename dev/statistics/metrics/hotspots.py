...
:class:`~dev.statistics.normalize.models.CallRecord` stream, where the leaf is the
record's full :attr:`~dev.statistics.normalize.models.CallRecord.subcommand` verb
