...
def default_reference_path() -> Path:
    ...
    The path is derived from this module's own location - ``dev/statistics``
    sits one level under the repository root - so it carries no absolute prefix
    or username. Callers may pass their own path to
    :func:`parse_capability_inventory` instead.
