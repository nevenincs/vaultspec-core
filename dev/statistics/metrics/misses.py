...
* **errors** - records whose
  :attr:`~dev.statistics.normalize.models.CallRecord.exit_status` is
  :attr:`~dev.statistics.normalize.exit_status.ExitStatus.ERROR`. A *findings* status
...
def _retry_corrections(records: list[CallRecord]) -> tuple[RetryCorrection, ...]:
    ...
    not off :attr:`~dev.statistics.normalize.models.CallRecord.retry_key`. That field
