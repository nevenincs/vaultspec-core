...
Two artifacts land in the gitignored ``dev/statistics/out/`` directory. The
``records.jsonl`` stream is the full normalized
:class:`~dev.statistics.normalize.models.CallRecord` set, one JSON object per line,
...
from dev.statistics.metrics.cost import compute_cost
from dev.statistics.metrics.feature_tags import compute_feature_tag_usage
from dev.statistics.metrics.features import compute_features_utilized
from dev.statistics.metrics.hotspots import compute_hotspots
from dev.statistics.metrics.misses import compute_misses
from dev.statistics.metrics.ngrams import compute_ngrams
from dev.statistics.metrics.surface import compute_surface
