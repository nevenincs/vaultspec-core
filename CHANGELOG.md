...
## [0.2.4](https://github.com/nevenincs/vaultspec-core/compare/vaultspec-core-v0.2.3...vaultspec-core-v0.2.4) (2026-09-19)
...
* **binaries:** bake a per-target distribution and gate it with --network none ([#496](https://github.com/nevenincs/vaultspec-core/issues/496)) ([6c56825](https://github.com/nevenincs/vaultspec-core/commit/6c5682592f9314eff810081994be03b7e57b5990))
* **binaries:** brand Windows executables ([6945d4e](https://github.com/nevenincs/vaultspec-core/commit/6945d4e0f8f72a1030468e2de9bf9fb2cc7459d9))
* **ci:** move the snapshot where the version is true, and check the artifact ([efbd86b](https://github.com/nevenincs/vaultspec-core/commit/efbd86beecd7b0ce78d51ef96490f65e14a6438c))
* **cli:** record what the published surface was, so the difference is computable ([d675211](https://github.com/nevenincs/vaultspec-core/commit/d6752110435e8124f57b3ebf9377f188a3ff7e56))
* **dev:** add the `just init` worktree initialization package ([c8fc2c2](https://github.com/nevenincs/vaultspec-core/commit/c8fc2c227d9c22168c20d923065729f321b31550))
* **dev:** annotate the diff with lint and type findings under CI ([fb5e8eb](https://github.com/nevenincs/vaultspec-core/commit/fb5e8eba7864bcef3ba5489a31d7c5018c574927))
* **dev:** give the harness a voice of its own ([7901647](https://github.com/nevenincs/vaultspec-core/commit/7901647362c62a61a1af906fd6a12613b3cbdd17))
* **dev:** report the population a test lane ran, and drop the reporters that never said anything ([a6945a9](https://github.com/nevenincs/vaultspec-core/commit/a6945a9f132656eb66c41fd7947cddaa599edae0))
* **docs:** generate the MCP tool table from the server that serves it ([0e2d819](https://github.com/nevenincs/vaultspec-core/commit/0e2d819413a1d6f17affe700f73486a46f42f3ec))
* **docs:** give generated references a candidate-versus-published contract ([#524](https://github.com/nevenincs/vaultspec-core/issues/524)) ([5a432ab](https://github.com/nevenincs/vaultspec-core/commit/5a432abf9043e1d7db12ed2e7d4e012ed7cc134f))
* **docs:** render the version caveat instead of writing it ([a02e639](https://github.com/nevenincs/vaultspec-core/commit/a02e639e9de1da9d1d3a665e2d2a70d188bdfe0e))
* **framework:** clarify the framework contract ([a777953](https://github.com/nevenincs/vaultspec-core/commit/a777953e0aae7054cc7894fbbf40fbc876bb7ff8))
...
* **justfile:** make `just init` the worktree entry point ([189071b](https://github.com/nevenincs/vaultspec-core/commit/189071b0d095e2067f44f644b8d1139b5e8c0203))
...
* **migrations:** an authoring verb converges where its write lands, and nothing else ([#495](https://github.com/nevenincs/vaultspec-core/issues/495)) ([51a6063](https://github.com/nevenincs/vaultspec-core/commit/51a606336fdb405cc046161d2b6c72cf17b634be)), closes [#458](https://github.com/nevenincs/vaultspec-core/issues/458)
...
* **audit:** align the dependency gate's exit codes with dev/exit_codes.py ([cbb2c6e](https://github.com/nevenincs/vaultspec-core/commit/cbb2c6e74c95ce006f485b1afa80d181b0de2616))
* **audit:** make the dependency gate multi-ecosystem and allowlist-driven ([aa1738c](https://github.com/nevenincs/vaultspec-core/commit/aa1738cb2366090785ebbf7725fd1dca7c09bf14))
...
* **builtins:** finish the reword the fallback sentence started ([bab6b39](https://github.com/nevenincs/vaultspec-core/commit/bab6b39a674bd73bbb366bf17f91bd581f5153bf))
* **ci:** prevent actionlint ShellCheck deadlock ([0a0a0de](https://github.com/nevenincs/vaultspec-core/commit/0a0a0de9c13c1536baed632c52327882aa2a783a))
...
* **cli:** exercise target source resolution under pytest ([cbae972](https://github.com/nevenincs/vaultspec-core/commit/cbae9723fdb8a35ebdce65435dd42756ad005b1e))
* **cli:** read --body-stdin as bytes, so a legacy byte survives the edit ([082f97a](https://github.com/nevenincs/vaultspec-core/commit/082f97a85058920042574cb332240df83dc9ff15))
* **cli:** read --body-stdin as bytes, so a legacy byte survives the edit ([#520](https://github.com/nevenincs/vaultspec-core/issues/520)) ([ff41aab](https://github.com/nevenincs/vaultspec-core/commit/ff41aab9c8d8c7cc48d469c009cfe013fa01c51f))
...
* **dev:** give the init report an argument-typed dict ([d0e3b29](https://github.com/nevenincs/vaultspec-core/commit/d0e3b2906ac68ce489fb691bcdd07b720a68a4c6))
* **dev:** report complexity offenders, not the whole census ([8df44ca](https://github.com/nevenincs/vaultspec-core/commit/8df44cae72e97303744861d9b0c14db7273ca66f))
* **dev:** speak UTF-8, so one accented character stops killing recipes ([1d7caca](https://github.com/nevenincs/vaultspec-core/commit/1d7caca61f077450d44fb8f29aa5e42df2b560c1))
* **dev:** state the shape of the foreign data the dev tooling reads ([7b5a6bf](https://github.com/nevenincs/vaultspec-core/commit/7b5a6bf16b7e3b08d70ca05f6d689c477c0924bb))
* **dev:** stop `audit all` silencing the one dimension that gates ([ea4d57b](https://github.com/nevenincs/vaultspec-core/commit/ea4d57b71ca657667f027d3985c61161a5874c66))
* **docs,ci:** say when provenance starts, and mint it in a job of its own ([#493](https://github.com/nevenincs/vaultspec-core/issues/493)) ([a8cf3a1](https://github.com/nevenincs/vaultspec-core/commit/a8cf3a1d25618e3dac8cfdb99159a0930a50ccfe))
...
* **framework:** align lifecycle checks and ADR transitions ([8287c55](https://github.com/nevenincs/vaultspec-core/commit/8287c55880100893f965b083b8d00ace35072acd))
* **framework:** align skills and personas with cohesive workflows ([af390dd](https://github.com/nevenincs/vaultspec-core/commit/af390ddfcf813135e226d7a8c6e98832eb73cefd))
* **framework:** separate decision coverage from execution effort ([072a8ee](https://github.com/nevenincs/vaultspec-core/commit/072a8ee88427effdde8592c43ff0cbc4a971da4c))
* **framework:** synchronize cohesive workflow and review guidance ([ce86e08](https://github.com/nevenincs/vaultspec-core/commit/ce86e0875a15c58c08a0a820f153dcffae37cbc8))
...
* **guards:** prove the exit-code guard's justfile corpus is non-empty ([e523925](https://github.com/nevenincs/vaultspec-core/commit/e52392502c7702b5cf78c0bfadbe28e8048db773))
...
* **release:** make `just release-binaries` build what the release builds ([6e4f795](https://github.com/nevenincs/vaultspec-core/commit/6e4f7956f4f7b85315cf7db4b23ba9fb9115b4dd))
* restore repository health gates ([cb58a57](https://github.com/nevenincs/vaultspec-core/commit/cb58a579899f212f023fe35c060b0372d3c08ae1))
...
* **tests:** close timing and harness blind spots ([#523](https://github.com/nevenincs/vaultspec-core/issues/523)) ([9249cb2](https://github.com/nevenincs/vaultspec-core/commit/9249cb2dd65b3cf048f1c80ee314fe44b1d0e382))
* **tests:** give the atomic-write races their real fsync back ([5df02ae](https://github.com/nevenincs/vaultspec-core/commit/5df02ae6b9890896ceed5394c91ff9e6f6d2d787))
* **tests:** give the stdio server a stderr it can actually inherit ([e7adba2](https://github.com/nevenincs/vaultspec-core/commit/e7adba2c5951287eda04f7091edb3a631e38e984))
* **tests:** make the working directory real, not patched ([986ebd9](https://github.com/nevenincs/vaultspec-core/commit/986ebd9628c4f18f4f3fd3a3e0980b960324ad65))
...
* **vault:** drop the frontmatter keys the merge wrote twice ([a3fd3a1](https://github.com/nevenincs/vaultspec-core/commit/a3fd3a18a52e2f7b31f96f16c9b6de4109543d5f))
* **vault:** drop the unclearable exec-mapping findings to INFO ([#501](https://github.com/nevenincs/vaultspec-core/issues/501)) ([ed12d66](https://github.com/nevenincs/vaultspec-core/commit/ed12d66801dca37739f1fb910a1e58d1245fb631))
* **vault:** follow renamed documents through `.md`-spelled links ([98df691](https://github.com/nevenincs/vaultspec-core/commit/98df69102a76d3468198e0819dd982494592b22f))
...
* **vault:** repair the merge artifacts in the test-provisioning records ([7790513](https://github.com/nevenincs/vaultspec-core/commit/77905133c08c654b07b8e888c915771f9025c796))
...
* **vault:** stop exec-mapping advising a ledger nobody can source ([#499](https://github.com/nevenincs/vaultspec-core/issues/499)) ([65b479d](https://github.com/nevenincs/vaultspec-core/commit/65b479d2ada52b76a0f34c94e39281112c0e6278))
...
* **ci:** let the test lanes use the cores the runners have ([6fd3b37](https://github.com/nevenincs/vaultspec-core/commit/6fd3b37140d13e53c27f48f900fc68e11d493924))
* **ci:** make the fast gate actually fast ([ec75584](https://github.com/nevenincs/vaultspec-core/commit/ec7558450847bb9facbaf8333cd434eade73e300))
* **tests:** build each provisioned workspace once, then clone it ([f3e1c16](https://github.com/nevenincs/vaultspec-core/commit/f3e1c166486946edb6c9120a137d1f1e8063ee48))
* **tests:** key the install template by shape, and stop rescanning every clone ([cc1cad6](https://github.com/nevenincs/vaultspec-core/commit/cc1cad6fae9164f0644450b2af4d5312717d44c4))
* **tests:** pay for provisioning and durability once, and finish the fallback reword ([#516](https://github.com/nevenincs/vaultspec-core/issues/516)) ([5b40718](https://github.com/nevenincs/vaultspec-core/commit/5b40718da220cfd1f5d65fbfe336be90c98ea304))
* **tests:** spend the runners' cores, and stop the harness breaking what it measures ([#521](https://github.com/nevenincs/vaultspec-core/issues/521)) ([bd1f9a6](https://github.com/nevenincs/vaultspec-core/commit/bd1f9a66174a2ef27ec939c2b7cc126b38db8f78))
* **tests:** stop paying for durability the suite cannot observe ([3763b51](https://github.com/nevenincs/vaultspec-core/commit/3763b51d6e0440c16ba2f1c9cce857b71ea99b97))


### Miscellaneous

* **release:** target framework 0.2.0 ([c4199d0](https://github.com/nevenincs/vaultspec-core/commit/c4199d03c627f34e3b301195309865d78ac61ffe))
