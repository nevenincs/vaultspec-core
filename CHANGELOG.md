...
## [0.1.46](https://github.com/nevenincs/vaultspec-core/compare/vaultspec-core-v0.1.49...vaultspec-core-v0.1.46) (2026-07-23)
...
* **cli-reference-automation:** add Typer-surface CLI-reference generator (P02.S05) ([8748cf7](https://github.com/nevenincs/vaultspec-core/commit/8748cf77238be03cce700bc731de5cbb3cec8db7))
...
* **cli:** plain-text output contract and status-discovery hardening ([7d71a7f](https://github.com/nevenincs/vaultspec-core/commit/7d71a7f76a0e7a0a343054f43a6b061cf8ba8239))
* **cli:** plain-text output contract and status-discovery hardening ([68b0c19](https://github.com/nevenincs/vaultspec-core/commit/68b0c194eca504176b81ed759c9d41b4073cff51))
...
* **graph-backend:** add derived relatedness edge module (P02.S11) ([9f15f9e](https://github.com/nevenincs/vaultspec-core/commit/9f15f9e5253fdc5fccb26a455757e0e7a18e0383))
* **graph-backend:** add ego-graph local scoping by node and depth (P02.S13) ([af444b0](https://github.com/nevenincs/vaultspec-core/commit/af444b0347e4b835a827604aebfbd06e405afdae))
* **graph-backend:** add fingerprint graph cache module (P04.S28) ([a7ae650](https://github.com/nevenincs/vaultspec-core/commit/a7ae65064124f955a863ad84c3f292eedcfdb4f8))
* **graph-backend:** add node, depth, derived toggles to vault graph (P02.S15) ([3bd0d8a](https://github.com/nevenincs/vaultspec-core/commit/3bd0d8a92faa458c8830000e97cb9c05a3ebc6a2))
* **graph-backend:** add pagerank and in-degree node-size hints (P02.S12) ([ca5d3d1](https://github.com/nevenincs/vaultspec-core/commit/ca5d3d1efa4161e0868cff419cbe0aaa9b0e2c74))
* **graph-backend:** attach kind, multiplicity, weight to explicit edges (P02.S10) ([0bf4947](https://github.com/nevenincs/vaultspec-core/commit/0bf4947b0dd301204d47bb9d059f78b73ced38c8))
* **graph-backend:** bump graph JSON envelope to vaultspec.vault.graph.v2 (P01.S04) ([60a1e9a](https://github.com/nevenincs/vaultspec-core/commit/60a1e9a6744d8c8eb084b65a897a90fd2f62961b))
* **graph-backend:** create vault link command group with list verb (P03.S21) ([9e69e8a](https://github.com/nevenincs/vaultspec-core/commit/9e69e8a4348c9c2d79b0142c8192f146f5880984))
* **graph-backend:** emit derived edges and node hints in v2 payload (P02.S14) ([41a1b61](https://github.com/nevenincs/vaultspec-core/commit/41a1b619c5ab0900cd4236bbf102134a18859bfc))
* **graph-backend:** implement vault link add with dangling refusal and dry-run (P03.S22) ([c123203](https://github.com/nevenincs/vaultspec-core/commit/c1232032985cc4199c261c1e009a484ef872e5e2))
* **graph-backend:** implement vault link remove with no-op detection and dry-run (P03.S23) ([a25e019](https://github.com/nevenincs/vaultspec-core/commit/a25e0199d67b07e755a20600d5280d77891c3948))
* **graph-backend:** invalidate graph cache from mutating verbs (P04.S30) ([f5fd041](https://github.com/nevenincs/vaultspec-core/commit/f5fd0414d7fad3c2ffd52d23813c6d55c590650c))
* **graph-backend:** preserve link multiplicity via Counter (P02.S08) ([327abaa](https://github.com/nevenincs/vaultspec-core/commit/327abaa6202c7a2e128d9b11f3391f98ec2b2895))
* **graph-backend:** register vault link group and regenerate CLI reference (P03.S24) ([7c258bd](https://github.com/nevenincs/vaultspec-core/commit/7c258bdcd3234023763c0e8695a05ef476afd19b))
* **graph-backend:** thread per-target link counts through graph build (P02.S09) ([d5ceb4f](https://github.com/nevenincs/vaultspec-core/commit/d5ceb4f41ec1b246341726c3a90e85cc301da1b2))
* **graph-backend:** wire graph cache load into construction (P04.S29) ([b7afca4](https://github.com/nevenincs/vaultspec-core/commit/b7afca4a58c7aba4ff1b67d91b51eb0967ed5afe))
...
* **vault-orientation:** research, ADR, and L3 plan; fix plan-mutator crash without workspace context ([5948d04](https://github.com/nevenincs/vaultspec-core/commit/5948d044f45475c25d5fd02f175a36e41ae20aa7))
* **vault-orientation:** W01.P01.S01 - add modified field and lenient date helpers to DocumentMetadata ([746d3de](https://github.com/nevenincs/vaultspec-core/commit/746d3de80bee390579ef9154a529faa0e2251c85))
* **vault-orientation:** W01.P01.S02 - surface the modified stamp through typed metadata parsing ([b320b96](https://github.com/nevenincs/vaultspec-core/commit/b320b960262eebf52f6b2a093f278be95e212fe3))
* **vault-orientation:** W01.P01.S03 - stamp modified equal to date at scaffold time ([f017a8c](https://github.com/nevenincs/vaultspec-core/commit/f017a8c8d29bce590576fc0dd7d0b02dcd13265e))
* **vault-orientation:** W01.P02.S05 - add modified schema row to the research template ([f1bce28](https://github.com/nevenincs/vaultspec-core/commit/f1bce28ecbcfddc149d071747e8f1a15b0f9a8f6))
* **vault-orientation:** W01.P02.S06 - add modified schema row to the reference template ([2dd0cac](https://github.com/nevenincs/vaultspec-core/commit/2dd0cace63410f3e42a7284b2b59720962d69daf))
* **vault-orientation:** W01.P02.S07 - add modified schema row to the adr template ([b8d0f6f](https://github.com/nevenincs/vaultspec-core/commit/b8d0f6ff1c8894652cae7587962ab938b9889d82))
* **vault-orientation:** W01.P02.S08 - add modified schema row to the plan template ([122e57a](https://github.com/nevenincs/vaultspec-core/commit/122e57ae079ed8d1001802fe4c81cc2a6a900c9a))
* **vault-orientation:** W01.P02.S09 - add modified schema row to the exec-step template ([1df5ac6](https://github.com/nevenincs/vaultspec-core/commit/1df5ac6dfcf27fa92c322738645b67cb261ce002))
* **vault-orientation:** W01.P02.S10 - add modified schema row to the exec-summary template ([59a3703](https://github.com/nevenincs/vaultspec-core/commit/59a3703ae045149b379f2d68a39a3db179a9c69b))
* **vault-orientation:** W01.P02.S11 - add modified schema row to the audit template ([6613799](https://github.com/nevenincs/vaultspec-core/commit/6613799597ade8e5bea1d3990a3bfe4079006c0f))
* **vault-orientation:** W01.P02.S12 - add modified schema row to the code-review template ([0082bdd](https://github.com/nevenincs/vaultspec-core/commit/0082bdd76755afb3bba4484dd9e4c98a24c381d8))
* **vault-orientation:** W01.P02.S13 - add modified schema row to the index template ([9e2f91c](https://github.com/nevenincs/vaultspec-core/commit/9e2f91ced1896d23f3248f93f22c27770c2484af))
* **vault-orientation:** W01.P03.S14 - refresh modified stamp on plan serialization writes ([4d4fafa](https://github.com/nevenincs/vaultspec-core/commit/4d4fafa67ddd77bcb7180da74e5a0ab8fcfc9d00))
* **vault-orientation:** W01.P03.S15 - refresh both ADR stamps on supersession ([2324317](https://github.com/nevenincs/vaultspec-core/commit/23243177f585457fcdd70d5b075049c2d5955c73))
* **vault-orientation:** W01.P03.S16 - refresh source audit stamp on rule promotion ([09e48c5](https://github.com/nevenincs/vaultspec-core/commit/09e48c55a584123ea4c89e164be38500c461b235))
* **vault-orientation:** W01.P03.S17 - refresh target stamp on link mutations ([6499c6d](https://github.com/nevenincs/vaultspec-core/commit/6499c6ded9f8fe633a84f1ee2f8c733cffdfe07a))
* **vault-orientation:** W01.P03.S18 - refresh stamps on repair-pipeline rewrites ([6f1e1e9](https://github.com/nevenincs/vaultspec-core/commit/6f1e1e925434ac445c5b52652d8cd97eafbd5026))
* **vault-orientation:** W01.P03.S19 - add mutator stamp-refresh integration tests ([e676707](https://github.com/nevenincs/vaultspec-core/commit/e6767078172af3bd354d27ec807b68d70878072b))
* **vault-orientation:** W01.P04.S20 - add modified-stamp checker ([1a5cc30](https://github.com/nevenincs/vaultspec-core/commit/1a5cc3037aedddfd10e17b5fd744e23cddcd66d4))
* **vault-orientation:** W01.P04.S21 - register modified-stamp checker ([23eb111](https://github.com/nevenincs/vaultspec-core/commit/23eb1110aafe28d7bae5c06760ec83227ddfc08c))
* **vault-orientation:** W01.P04.S22 - add modified-stamp checker tests ([0089219](https://github.com/nevenincs/vaultspec-core/commit/00892197e64b5dce762d6e6cccbccaa06b933429))
* **vault-orientation:** W01.P04.S23 - add modified-stamp backfill migration ([2d7fa0d](https://github.com/nevenincs/vaultspec-core/commit/2d7fa0deee0bfdb3f1a94f837a5f12608a8e6c40))
* **vault-orientation:** W01.P04.S24 - add backfill migration tests; reconcile checker with repair pipeline ([c75d08f](https://github.com/nevenincs/vaultspec-core/commit/c75d08fe5b0a938f30431e4b080c700dd40a7b1e))
* **vault-orientation:** W02.P05.S25 - batched all-plans status collector sharing one exec-record index ([67aebf8](https://github.com/nevenincs/vaultspec-core/commit/67aebf8ae8817bb77f5325e326274552725527c7))
* **vault-orientation:** W02.P05.S26 - orientation rollup and grounding-trace data layer ([246ea5e](https://github.com/nevenincs/vaultspec-core/commit/246ea5e1c51aca84378789e6c3f38016597d1fc1))
* **vault-orientation:** W02.P05.S27 - orientation core tests over a real tmp_path vault ([df4f777](https://github.com/nevenincs/vaultspec-core/commit/df4f7771fd5369569973a13bd9d7b18d6b6bef60))
* **vault-orientation:** W02.P06.S28 - add vault status verb with rollup and trace modes ([1caaf60](https://github.com/nevenincs/vaultspec-core/commit/1caaf60de75470fc020ced2fb715373586237345))
* **vault-orientation:** W02.P06.S29 - add vault status cli tests for both modes, hints, and json schema ([014249b](https://github.com/nevenincs/vaultspec-core/commit/014249b6dd1844742039fed382696a17ef94340e))
* **vault-orientation:** W03.P07.S30 - document modified frontmatter stamp ([b09e02a](https://github.com/nevenincs/vaultspec-core/commit/b09e02a21218a25f3d33767c7cabbc4611170eee))
* **vault-orientation:** W03.P07.S31 - add vault status command row and orientation mandate ([ff7813c](https://github.com/nevenincs/vaultspec-core/commit/ff7813ca21a865f5df8851c394c8df44564fca1c))
* **vault-orientation:** W03.P07.S32 - add zeroth-move orientation paragraph ([5e8e3f6](https://github.com/nevenincs/vaultspec-core/commit/5e8e3f6b8eaaf87381e95d902abe05cc4524b09a))
* **vault-orientation:** W03.P07.S33 - add modified to curator allowed keys with repair note ([5f5b3db](https://github.com/nevenincs/vaultspec-core/commit/5f5b3db4de6ab50b59f05c9f3cf83f7c62141df0))
* **vault-orientation:** W03.P08.S34 - vault status reference prose ([196cc07](https://github.com/nevenincs/vaultspec-core/commit/196cc07b90a33b011f8cfb40f01d18ae79cc2293))
* **vault-orientation:** W03.P08.S35 - orientation and stamp in framework manual ([18b158c](https://github.com/nevenincs/vaultspec-core/commit/18b158cfe56f7abfa1b7905644a56da15d590bd2))
...
* **vault:** add rename verb for document file-rename with incoming-link rewrite ([#172](https://github.com/nevenincs/vaultspec-core/issues/172)) ([c1f2bca](https://github.com/nevenincs/vaultspec-core/commit/c1f2bca1c1619c65d11aab37d6b314cda22fa8af))
* **vault:** add set-body/set-frontmatter/edit verbs with blob-hash concurrency and conformance validation ([#168](https://github.com/nevenincs/vaultspec-core/issues/168)) ([d375710](https://github.com/nevenincs/vaultspec-core/commit/d3757108850cf41fcb657062e805ad9c1340b9d3))
...
* **vault:** ref-scoped graph, commit-linkage trailers, phase-summary scaffold, doctor + plan-mutator fixes ([c209baf](https://github.com/nevenincs/vaultspec-core/commit/c209baf3cefe2b9c57be0bd3f5b3e85750292567))
* **vault:** ref-scoped graph, commit-linkage trailers, phase-summary scaffold, doctor and plan-mutator fixes ([dc984ff](https://github.com/nevenincs/vaultspec-core/commit/dc984ffdcd0e5bedd1664fb2dbe48e1c6ef15f12)), closes [#153](https://github.com/nevenincs/vaultspec-core/issues/153) [#157](https://github.com/nevenincs/vaultspec-core/issues/157) [#158](https://github.com/nevenincs/vaultspec-core/issues/158) [#159](https://github.com/nevenincs/vaultspec-core/issues/159) [#160](https://github.com/nevenincs/vaultspec-core/issues/160)
...
* **cli-reference-automation:** distinct error for reversed region markers (GENREVIEW-001) ([d5c7016](https://github.com/nevenincs/vaultspec-core/commit/d5c70166eaf9afa25a216616bcf4c67c5deadceb))
* **cli-reference-automation:** guard duplicated region markers (GENREVIEW-002) ([17a8d9c](https://github.com/nevenincs/vaultspec-core/commit/17a8d9c6d57c5bdfd8046efc94af8200f96de71d))
* **cli-reference-automation:** lift template-name map to module scope (P01.S02) ([df23714](https://github.com/nevenincs/vaultspec-core/commit/df237143c768e3de08267ad28d96c266212825cb))
* **cli-reference-automation:** make docs/CLI.md inventory generator-owned (GENREVIEW-003) ([327dcfc](https://github.com/nevenincs/vaultspec-core/commit/327dcfc9328d4584b8a32f1957e22078e605cf82))
* **cli-reference-automation:** make spec reference group visible (P02.S05) ([9e8d53a](https://github.com/nevenincs/vaultspec-core/commit/9e8d53a1f5c98858bc328290f557bc982963baae))
* **cli-reference-automation:** mark ref-audit.md legacy fallback for removal (P01.S01) ([dd11e7f](https://github.com/nevenincs/vaultspec-core/commit/dd11e7f5d7dc3209018ad122527766901f9baf5c))
...
* **firmware:** legacy template-name fallback for stale workspaces (P09.S126) ([38da3f4](https://github.com/nevenincs/vaultspec-core/commit/38da3f49ade421442da8a0ad487d28e08377940f))
* **graph-backend:** eliminate duplicate metrics pass in to_dict (P01.S03) ([364097d](https://github.com/nevenincs/vaultspec-core/commit/364097d114fd02dd5069ef08719a74c1ccafd988))
* **graph-backend:** harden cache save and benchmark slack (P04 review M3, L3) ([d3bc283](https://github.com/nevenincs/vaultspec-core/commit/d3bc2832ce9a6583d91705bf50b279862de15f4b))
* **graph-backend:** invalidate cache from remaining vault-mutating verbs (P04 review M1) ([35dc759](https://github.com/nevenincs/vaultspec-core/commit/35dc759bd2acba651aab0f5ec2dceb9703c93934))
* **graph-backend:** normalise inline related: lists in surgery helper (P03 review C1) ([14de9ee](https://github.com/nevenincs/vaultspec-core/commit/14de9eecc0be5756bd0bcc82b49fefefe14e20b2))
* **graph-backend:** pass explicit edges= key to node_link_data (P01.S01) ([e859d2a](https://github.com/nevenincs/vaultspec-core/commit/e859d2ad1bb899d61132b3e2dd8bebf4c01384d1))
* **graph-backend:** sort _stem_index keys for cross-platform determinism ([8c7335c](https://github.com/nevenincs/vaultspec-core/commit/8c7335c9f1e58a97a3dbb3d79d01141f6376039d))
...
* **graph-backend:** scope derived-edge computation to the queried node set (P02 review HIGH-2) ([376a189](https://github.com/nevenincs/vaultspec-core/commit/376a189178149e43ee4a3137d05cb4f3a70beea3))
